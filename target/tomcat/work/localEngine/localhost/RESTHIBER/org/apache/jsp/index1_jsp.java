 ...
 String error; String output; 
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <input type=\"text\" id=\"textt\">\r\n");
      out.write("        <INPUT TYPE=\"BUTTON\" VALUE=\"POST\" ONCLICK=\"POST()\">\r\n");
      out.write("<INPUT TYPE=\"BUTTON\" VALUE=\"GET\" ONCLICK=\"GET()\">\r\n");
      out.write("     <SCRIPT>\r\n");
      out.write("         function POST()\r\n");
      out.write("        {\r\n");
      out.write("            window.location = 'index2.jsp';\r\n");
      out.write("        } \r\n");
      out.write("         function GET()\r\n");
      out.write("         {\r\n");
      out.write("        \t console.log(document.getElementsByName(\"buttonName\").value);\r\n");
      out.write("             window.location = 'index3.jsp';\r\n");
      out.write("         } \r\n");
      out.write("     </SCRIPT>\r\n");
...
if(request.getParameter("buttonName") == "GET") {
    ...
    out.println(output);
    //----------------------End of test GET ------------------------------------------------------------
}else if(request.getParameter("buttonName") == "POST") {
...
//----------------------End of test POST  -------------------------------------------------
}else if(request.getParameter("buttonName") == "PUT") {
 ...
 */
     ...
     out.println(output);
   //----------------------End of test PUT ------------------------------
}else if(request.getParameter("buttonName") == "DELETE") {  
...
*/
	...
	System.out.println("not categorized");
}	
